...
describe("save jobs", function(){
    it('should validate that title is greate than 4 characters');
    it('should validate that title is less than 40 characters');
    it('should validate that description is greate than 4 characters');
    ...
    it('should return status of 200 to the front end if the db saved');
    it('should return the job with an id');
